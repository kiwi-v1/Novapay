...
const VOLT_ISSUER = process.env.NEXT_PUBLIC_VOLT_ISSUER || 'GB2XT6VJBAT53Y6WKVUDDIOULUFB2F74XDGAMEGTB4IXHOOIV23GBKPZ';
...
export const useTrustline = (publicKey: string) => {
  ...
  const addTrustline = async () => {
    ...
    try {
      ...
      const voltAsset = new Asset('VOLT', VOLT_ISSUER);
